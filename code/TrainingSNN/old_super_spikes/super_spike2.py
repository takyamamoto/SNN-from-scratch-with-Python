...
y = np.zeros((nt, N_out))
target = []
target.append([500,2500,3500,4000,4500,5000,5500,6500,8500,9500,10000,10500,11000,13000,13500,14000,15500,17500])
target.append([500,1000,2500,3500,6500,8500,9500,11500,12500,14500,15500,16000,17500])
target.append([500,1500,2500,3500,4000,4500,5000,5500,6500,8500,9500,10000,10500,11000,12500,14500,15500,16500,17500])
target.append([500,2000,2500,3500,6500,8500,9500,11000,12500,14500,15500,17000,17500])
target.append([500,2500,3500,4000,4500,5000,5500,7000,7500,8000,9500,11500,13000,13500,14000,15500,17500])
...
for j in range(N_out):
    plt.plot(t, (v_arr[j]+60)/100+(N_out-j))
plt.title('LIF neurons')
plt.xlabel('Time (s)')
plt.ylabel('Neuron Index') 
plt.tight_layout()
...
plt.figure(figsize=(8, 2))
for j in range(N_out):
    plt.scatter(t, (v_arr[j]>=-50)*(j+1), marker="o", color="k")
plt.title('LIF neurons')
plt.xlabel('Time (s)')
plt.ylabel('Neuron Index') 
plt.ylim(0.5, N_out+0.5)
